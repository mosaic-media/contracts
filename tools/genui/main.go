...
// proved what happens to those. It is also most of why DivKit and Beagle are
// usable by people who did not write them — a contract nobody can read without
// reading its source is a contract with one implementer.
//
